...
class MutationCounter():
    ...
    def find_cell_gene_mut_counts(self, stream=None, path=None):
        ...
        for record in vcf_reader:
            ...
            filtered_gene_mutation_counts[gene_name] = filtered_gene_mutation_counts.get(gene_name, 0) + 1
    ...
    def find_mutation_counts(self, paths, processes=4):
        ...
        for cell_name, (mutation_counts, filtered_mutation_counts) in results:
            ...
            filtered_cell_genmuts_pairs.append((cell_name, filtered_mutation_counts))
...
def count_mutations(processes, cosmicdb, refgenome, outfile, files):
    ...
    result_df, filtered_result_df = mutation_counter.find_mutation_counts(files, processes=processes)
    ...
    filtered_result_df.to_csv(
        outfile
            .with_name(outfile.stem + "_filtered")
            .with_suffix(outfile.suffix)
    )
